...
Представьте, что у вас курьер с заказом:

- Раньше он мог привезти **не готовый товар**, а тестовую болванку «чисто проверить коробку».
- Теперь правило жёсткое: либо привозит **нормальный рабочий продукт с интерфейсом**, либо честно говорит «не смог собрать».

То есть в релиз больше не должен просачиваться технический вариант без нормального окна приложения.
